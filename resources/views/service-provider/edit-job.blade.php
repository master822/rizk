    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-rizk p-4">
                ...
                <form action="{{ route('service-provider.jobs.update', $job->id) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control form-rizk" rows="5">{{ $job->description }}</textarea>
                    </div>
                    <div class="mb-3">
