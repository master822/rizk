    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card-rizk p-4">
                <h4 class="text-center mb-4" style="color: var(--text-primary);">الملف الشخصي - مقدم خدمات</h4>
                ...
                <div class="mt-3 text-center">
                    <a href="{{ route('service-provider.change-password') }}" class="btn btn-rizk-outline w-100">تغيير كلمة المرور</a>
                </div>
            </div>
        </div>
    </div>
