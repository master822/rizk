    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card-rizk text-center p-4">
                ...
                <p style="color: var(--text-muted);"><i class="fas fa-phone me-2"></i>{{ $user->phone ?? 'غير محدد' }}</p>
                <p style="color: var(--text-muted);"><i class="fas fa-map-marker-alt me-2"></i>{{ $user->city ?? 'غير محدد' }}</p>
                <hr>
                <a href="{{ route('change-password') }}" class="btn btn-rizk-outline w-100">تغيير كلمة المرور</a>
            </div>
        </div>
        <div class="col-md-8">
